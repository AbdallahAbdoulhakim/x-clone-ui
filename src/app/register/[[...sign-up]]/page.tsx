        ...
        <SignUp.Root>
          <SignUp.Step name="start" className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Clerk.Field name="username" className="flex flex-col gap-2">
                <Clerk.Input
                  className="bg-white outline-none py-2 px-6 rounded-full text-black w-72 placeholder:text-sm"
          ...
          <SignUp.Step name="verifications">
            <SignUp.Strategy name="email_code">
              ...
              <SignUp.Action
                submit
                className="w-72 py-2 px-6 rounded-full outline-none mt-2 font-bold bg-iconBlue text-white text-sm"
              >
                Verify
              </SignUp.Action>
            </SignUp.Strategy>
